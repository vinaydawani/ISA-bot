...
class events(commands.Cog):
    ...
    async def on_ready(self):
        ...
        await self.bot.change_presence(status=discord.Status.online, activity=discord.Activity(type=discord.ActivityType.watching, name='for commands starting with !!, isa! or i!'))
